function stockwatcher(){
  ...
  stockwatcher.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules['stockwatcher'].bindings;
    activeModules['stockwatcher'].bindings = function(){
    ...
    function installCode(code_0){
      ...
      if (stockwatcher.__errFn) {
        script.onerror = function(){
          stockwatcher.__errFn('stockwatcher', new Error('Failed to load ' + code_0));
        }
        ;
      }
